...
export const metadata: Metadata = {
  title: 'Uses',
  description: 'Software I use, gear I rely on, and tools I actually recommend.',
}
...
export default function Uses() {
  return (
    <SimpleLayout
      ...
      intro="People ask what I use to build and stay productive. Here's the honest answer — the stuff that's actually on my desk and in my dock, not a sponsored list."
    >
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          <Tool title="MacBook Pro 14&quot;, M3 Pro (2023)">
            The M-series chips changed everything. I can run local AI models,
            spin up Docker containers, and have 40 browser tabs open without
            the fans ever turning on. I don't miss Intel at all.
          </Tool>
          <Tool title="LG UltraWide 34&quot; Monitor">
            One wide screen beats two monitors for me. Enough room to have a
            code editor, terminal, and browser side by side without any
            window juggling.
          </Tool>
        ...
        <ToolsSection title="Development">
          <Tool title="Cursor" href="https://cursor.sh">
            AI-first code editor built on VS Code. The tab completion and
            inline chat are genuinely magical — it's the first tool that made
            me feel like AI is actually augmenting my thinking rather than just
          ...
          <Tool title="Warp" href="https://warp.dev">
            A terminal that doesn't feel like 1987. AI command suggestions and
            shared runbooks make it way more useful than iTerm2 ever was for me.
          </Tool>
          <Tool title="TablePlus" href="https://tableplus.com">
            The best database GUI. Works with Postgres, MySQL, SQLite, Redis —
            whatever you're running. Has saved me from building a thousand admin
            interfaces over the years.
          </Tool>
          <Tool title="Bun" href="https://bun.sh">
            Faster installs, faster test runs, faster everything. I've switched
            all my projects over and haven't looked back.
          </Tool>
        </ToolsSection>
        ...
        <ToolsSection title="Productivity">
          ...
          <Tool title="Linear" href="https://linear.app">
            Issue tracking that doesn't get in your way. Fast, opinionated, and
            beautiful. The keyboard shortcuts alone make it worth it.
          </Tool>
