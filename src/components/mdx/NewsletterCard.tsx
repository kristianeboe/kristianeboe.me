    ...
    <section className="not-prose relative my-8 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg transition-shadow hover:shadow-xl">
      ...
      >
        <div
          ...
          className="absolute right-0 bottom-0 aspect-[1155/678] w-[36.125rem] translate-x-[20%] translate-y-[30%] rotate-12 bg-linear-to-tr from-amber-300 to-amber-600 opacity-20 sm:w-[48rem]"
        />
      </div>
    </section>
  );
